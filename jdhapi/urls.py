...
urlpatterns = [
    ...
    path("api/articles/submissions/ojs", views.get_count_submission_from_ojs, name="count-submission-from-ojs"),
    path("api/articles/submission/ojs", views.send_article_to_ojs, name="articles-send-to-ojs"),
