...
urlpatterns = [
    ...
    path('api/abstracts/<str:pid>/', views.AbstractDetail.as_view(), name='abstract-detail'),
    path('api/articles/', views.ArticleList.as_view(), name='article-list'),
    path('api/articles/<str:abstract__pid>/', views.ArticleDetail.as_view(), name='article-detail'),
