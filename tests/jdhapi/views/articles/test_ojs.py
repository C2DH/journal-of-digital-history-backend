...
class SendArticleToOJSTestCase(TestCase):
    ...
    def test_send_article_to_ojs_not_authenticated(self):
        ...
        response = self.client.post(self.url, self.valid_payload,headers='', format='json')
    ...
    def test_send_article_to_ojs_success(self, mock_put, mock_post, mock_pdf):
        ...
        self.assertEqual(response.data['message'], 'Article(s) send successfully to OJS.')
    ...
    def test_send_article_to_ojs_metadata_assignment_fails(self, mock_put, mock_post, mock_pdf):
        ...
        mock_blank_submission = Mock()
        mock_blank_submission.status_code = 201
        mock_blank_submission.json.return_value = {'id': 123, 'currentPublicationId': 456}
